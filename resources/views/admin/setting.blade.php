	...
	<section id="content">
		...
		<main>
			...
			<div class="table-data">
				...
				<div class="todo" style="max-height: 432px">
					<div class="head">
						<h3>Mục lục</h3>
                    ...
                    <div id="active-form" class="todo-list">
                        <ul class="nav tabs" id="menu_tabs">
                            <li class="completed current" data-tab="a"> <p class="p"> <i style="padding-right: 10px" class="fa-solid fa-house"></i>Thông Tin Chung</p> <i class='bx bx-dots-vertical-rounded' ></i> </li>
                            <li class="completed " data-tab="b"> <p class="p"> <i style="padding-right: 10px" class="fa-solid fa-image"></i>Logo</p> <i class='bx bx-dots-vertical-rounded' ></i> </li>
                            <li class="completed " data-tab="c"> <p class="p"> <i style="padding-right: 10px" class="fa-solid fa-file-lines"></i>Nội Dung - Trang Chủ</p> <i class='bx bx-dots-vertical-rounded' ></i> </li>
                            <li class="completed " data-tab="d"> <p class="p"> <i style="padding-right: 10px" class="fa-sharp fa-solid fa-share-nodes"></i>Social</p> <i class='bx bx-dots-vertical-rounded' ></i> </li>
                            <li class="completed " data-tab="e"> <p class="p"> <i style="padding-right: 10px" class="fa-brands fa-facebook"></i>Tích Hợp Facebook</p> <i class='bx bx-dots-vertical-rounded' ></i> </li>
                        </ul>
                    </div>
				...
				<div class="order">
                    ...
                    <div class="col-12">
                        <form class=" none " action="{{ route('setting-up') }}" method="POST" id="d">
                            @csrf
                            <div class="-space-y-px mb-4">
                                <div class="containerInput ">
                                    <div class="form-group">
                                ...
                                <div class="containerInput ">
                                    <div class="form-group ">
                                        ...
                                        <div class="repeater">
                                            ...
                                            <input data-repeater-create type="button" class="d" value="Add New"/>
                                        </div>

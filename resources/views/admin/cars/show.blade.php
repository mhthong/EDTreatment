...
@section('main')
    ...
    <section id="content">
        ...
        <main>
            ...
            id="add-blog-post-form" method="post" action=""
            enctype="multipart/form-data">
                ...
                <div class="table-data">
                    <div class="order">
                        ...
                        <div class=" containerInput  twothirds p-3">
                            ...
                            <div id="form-option">
                                ...
                                <input type="text" id="length" name="length" placeholder="4940" value="@isset($array['length']){{ $array['length'] }}
                                @endisset" required><br>

                                <label for="width">Rộng:</label>
                                <input type="text" id="width" name="width" placeholder="1960" value="@isset($array['width']){{ $array['width'] }}
                                @endisset" required><br>

                                <label for="height">Cao:</label>
                                <input type="text" id="height" name="height" placeholder="1773" value="@isset($array['height'] ){{ $array['height']  }}
                                @endisset" required><br>
                   ...
                   <input type="munber" name="price_with_battery" id="price_with_battery" placeholder="" required value="@isset($array['price_with_battery']){{ $array['price_with_battery'] }}
                   @endisset" required />
                   ...
                   <input type="text" name="Maximum_torque" id="Maximum_torque" placeholder="" required value="@isset($array['Maximum_torque']){{ $array['Maximum_torque'] }}
                   @endisset" required />
                   <label for="">Số ghế ngồi</label>
                   <input type="munber" name="seats" id="seats" placeholder="" required value="@isset($array['seats']){{ $array['seats'] }}
                   @endisset" required />

    ...
    <section class="panel important" >
        ...
        <div class="table-users" style="width: 100%">
            ...
            <table cellspacing="0">
                ...
                <tr>
                    <td class="des-tb col-2">{{$row->name_customer}}</td>
                    <td class="des-tb flexb-c col-2">{{$row->phone_customer}}</td>
                    <td class="des-tb flexb-c col-2">{{$row->address_customer}}</td>
                    <td class="des-tb flexb-c col-2">{{$row->mail_customer}}</td>
                    <td class="des-tb flexb-c col-3">{{$row->content_customer}}</td>

                    <td class="edit-tb flexb-c col-1"  ><a href="{{ route('informations.view', ['id' => $row->id]) }}"><button class="btn btn-primary" >View</button>
                    </td>

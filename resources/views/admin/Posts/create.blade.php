                        ...
                        <div class="widget-body">
                            ...
                            <div class="seo-edit-section hidden">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" class="form-control" id="seo_title" placeholder="Tiêu đề trang"
                    ...
                    <div class="mt-3">
                        ...
                        <div class="widget meta-boxes">
                            ...
                            <div class="widget-body">
                                ...
                                <input class="form-control" class="tags" data-role="tagsinput" placeholder="Write some tags"
                                    data-url="" name="tag"
                                    type="text" id="tag">
                            </div>
                        </div>
